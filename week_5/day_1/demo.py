...
if __name__ == '__main__':
    p = PGSQL()
    p.create_tables(r'C:\Users\Logan\Documents\GitHub\bootcamp\week_5\day_1\amazon_mock_create (1).sql')
    p.insert_data(r'C:\Users\Logan\Documents\GitHub\bootcamp\week_5\day_1\amazon_mock_insert (1).sql')
